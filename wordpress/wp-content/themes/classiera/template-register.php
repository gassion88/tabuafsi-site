						...
						<div class="col-lg-8 col-sm-11 col-md-9 center-block">
							<form data-toggle="validator" role="form" id="myform" action="" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-9 col-sm-9">
                                            <div class="inner-addon left-addon">
                                                ...
                                                <input type="text" id="username" name="username" class="form-control form-control-md" placeholder="<?php esc_html_e('Enter username', 'classiera') ?>" data-error="<?php esc_html_e('Username required', 'classiera') ?>" pattern="[a-zA-Z0-9]+" required>
								...
								<div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-9 col-sm-9">
                                            <div class="inner-addon left-addon">
                                                <i class="left-addon form-icon fas fa-lock"></i>
                                                <input id="confirmPass" type="password" name="confirm" class="form-control form-control-md sharp-edge" placeholder="<?php esc_html_e('re-enter password', 'classiera') ?>" data-match="#registerPass" data-match-error="<?php esc_html_e('Whoops, these don&rsquo;t match', 'classiera') ?>" data-error="<?php esc_html_e('Re-enter password', 'classiera') ?>" required>
                                                <div class="help-block with-errors"></div>
                                            </div>
                                        </div>
                                    </div>
								...
								<div class="col-lg-9 col-sm-9 pull-right flip">
                                    <div class="form-group">
                                        <div class="checkbox">
                                            <input type="checkbox" name="remember" id="remember" value="forever" data-error="<?php esc_html_e('You must agree to our Terms & Conditions', 'classiera') ?>" required>
