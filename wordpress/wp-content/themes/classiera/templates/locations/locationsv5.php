								...
								<figure class="location">
									...
									<figcaption>
										...
										<div class="location-caption">
											...
											<a href="<?php echo esc_attr($locationURL.$countryName);?>"><?php esc_html_e( 'View all ads', 'classiera' ); ?> <i class="fas fa-long-arrow-alt-<?php if(is_rtl()){echo "left";}else{echo "right";}?>"></i></a>
										</div>
									</figcaption>
								</figure>
							</div>
