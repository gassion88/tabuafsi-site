...
?>
   ...
   <script type="text/javascript">      
	jQuery(document).ready(function(){
        jQuery('#clock').countdown('<?php echo esc_attr($comingYear); ?>/<?php echo esc_attr($comingMonth); ?>/<?php echo esc_attr($comingDays); ?>', function(event) {
            ...
            var h = $(window).height();
            jQuery('.comingSoon__content').css('height', h);
	});		
    </script>
</body>
</html>