						...
						<div class="form-main-section post-location">
											...
											<div class="form-inline row">
												<div class="col-sm-12">
													<div class="input-group">
														...
														<input type="text" name="post_state" class="form-control form-control-md" placeholder="<?php esc_html_e('Type your state name..!', 'classiera') ?>">
													</div>
												</div>
											</div>
										</div>
											...
											<div class="form-inline row">
												<div class="col-sm-12">
													<div class="input-group">
														...
														<input type="text" name="post_city" class="form-control form-control-md" placeholder="<?php esc_html_e('Type your city name..!', 'classiera') ?>">
													</div>
												</div>
											</div>
										</div>
							...
							<div class="form-group">
								<?php 
									...
									if($googleFieldsOn == 1){
								?>
                                <label class="col-sm-3 control-label"><?php esc_html_e('Set Latitude & Longitude', 'classiera') ?> : <span>*</span></label>
									<?php } ?>
