	...
	<div class="container">
		<div class="row">
			<div class="col-lg-8 center-auto">
				<form class="minimal_page_search_form" action="<?php echo home_url(); ?>" method="get">
					<div class="form-group">
						<div class="input-group">
							<div class="input-group-addon left-addon">
								<i class="zmdi zmdi-border-color"></i>
							</div>
							<input type="text" class="form-control" placeholder="<?php esc_html_e( 'Enter what are you looking', 'classiera' ); ?>" name="s">
						</div>
					</div><!--form-group-->
					<div class="form-group">
						<div class="input-group">
							...
							<input type="text" class="form-control" placeholder="<?php esc_html_e('Please type your location', 'classiera'); ?>" name="<?php echo esc_attr($classieraLocationName); ?>">
						</div>
					</div><!--form-group-->
					<button type="submit" name="search" value="<?php esc_html_e( 'Search', 'classiera' ); ?>">
