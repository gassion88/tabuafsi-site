                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-sm-6 col-xs-6">
                        <div class="view-as text-right flip">
							...
							<a id="grid-medium" class="grid-medium btn btn-sm sharp outline <?php if($classieraAdsView == 'medium'){ echo "active"; }?>" href="#">
								<i class="fa fa-th"></i>
							</a>
                            <a id="list" class="list btn btn-sm sharp <?php if($classieraAdsView == 'list'){ echo "active"; }?>" href="#">
