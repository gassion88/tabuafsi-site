					...
					<div class="form-v6-bg">
						...
						<div class="form-group classieraAjaxInput">
							<div class="input-group inner-addon left-addon">
								...
								<input type="text" <?php if($classiera_remove_ajax == 1){ ?>id="classieraSearchAJax" <?php } ?> name="s" class="form-control form-control-lg" placeholder="<?php esc_html_e( 'Enter keyword...', 'classiera' ); ?>" data-error="<?php esc_html_e( 'Please Type some words..!', 'classiera' ); ?>">
