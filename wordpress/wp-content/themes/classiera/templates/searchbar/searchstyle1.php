			...
			<div class="col-md-12">
				<form data-toggle="validator" role="form" class="search-form search-form-v1 form-inline" action="<?php echo home_url(); ?>" method="get">
					<div class="form-group classieraAjaxInput">
                        <input type="text" name="s" <?php if($classiera_remove_ajax == 1){ ?>id="classieraSearchAJax" <?php } ?> class="form-control form-control-sm sharp-edge " placeholder="<?php esc_html_e( 'Enter keyword...', 'classiera' ); ?>" data-error="<?php esc_html_e( 'Please Type some words..!', 'classiera' ); ?>">
