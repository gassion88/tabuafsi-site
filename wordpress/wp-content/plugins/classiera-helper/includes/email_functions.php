...
if(!function_exists('classiera_post_status_email')) { 
	...
	function classiera_post_status_email( $new_status, $old_status, $post ){
		...
		if ($new_status == 'rejected'){	
			...
			<div class="classiera-email-content" style="padding: 50px 0; width:600px; margin:0 auto;">
				<p style="font-size: 16px; font-family: 'Lato', sans-serif; color: #6c6c6c;">
					<?php esc_html_e( 'Unfortunately, your has been rejected, which you was posted on', 'classiera-helper' ); ?> &nbsp;<?php echo get_bloginfo('name'); ?>
				</p>
				<p style="font-size: 16px; font-family: 'Lato', sans-serif; color: #6c6c6c;">
					<?php esc_html_e( 'This may be due to the content in your Ad that goes against our Terms of Service.', 'classiera-helper' ); ?>
				</p>
				<p style="font-size: 16px; font-family: 'Lato', sans-serif; color: #6c6c6c;">
		...
		if($new_status === 'publish' && $old_status !== 'publish' && $post->post_type === 'post'){
			...
			<div class="classiera-email-content" style="padding: 50px 0; width:600px; margin:0 auto;">
				<p style="font-size: 16px; font-family: 'Lato', sans-serif; color: #6c6c6c;">
					<?php esc_html_e( 'Hi', 'classiera-helper' ); ?>, <?php echo esc_attr($author->display_name) ?>. <?php esc_html_e( 'Just a note to let you know your Ad', 'classiera-helper' ); ?> 
		...
		if($new_status === 'trash' || $new_status === 'expired' && $old_status === 'publish' && $post->post_type === 'post'){
			...
			<div class="classiera-email-content" style="padding: 50px 0; width:600px; margin:0 auto;">
				...
				<p style="font-size: 16px; font-family: 'Lato', sans-serif; color: #6c6c6c;"><?php esc_html_e( 'Your post title', 'classiera-helper' ); ?> : <?php echo get_the_title(); ?> </p>
