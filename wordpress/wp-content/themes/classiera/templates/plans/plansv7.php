...
?>
<section class="pricing-plan-v6 pricing-plan-v7 section-pad">
				...
				<div class="col-lg-3 col-md-3 col-sm-6 match-height price-plan-v6">
					<div class="pricing-plan-box <?php if($popular_plan == 'true'){echo "popular";} ?>">
						<div class="pricing-plan-heading">
							...
							<span>
								<?php if($free_plans == 1){?>
									<?php esc_html_e( 'Ads will shown on regular place', 'classiera' ); ?>
								<?php }else{?>
						...
						<form method="post" class="planForm">
							...
							if($free_plans == 1){
								...
								?>
							<a class="btn btn-primary outline radius btn-style-six" href="<?php echo esc_url($link); ?>">
								...
								?>
							<a rel="nofollow" href="#" data-quantity="1" data-product_id="<?php echo esc_attr($wooID); ?>" data-product_sku="" class="classiera_plan_add_to_cart btn btn-primary outline radius btn-style-six">
							<?php esc_html_e( 'Purchase Now', 'classiera' ); ?>
							</a>
								<?php
								}else{
									?>
									<a rel="nofollow" href="<?php echo esc_url($login); ?>" class="btn btn-primary outline radius btn-style-six">
									<?php esc_html_e( 'Purchase Now', 'classiera' ); ?>
									</a>
									<?php
								}
						...
						<div class="viewcart pricing-plan-button text-center">
							<a class="btn btn-primary outline radius btn-style-six" href="<?php echo esc_url($classieraCartURL); ?>">
