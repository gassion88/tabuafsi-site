						...
						<form data-toggle="validator" role="form" method="POST" id="primaryPostForm" action="" enctype="multipart/form-data" autocomplete="off">
                            ...
                            <div class="media">
                                ...
                                <div class="media-body">
                                    ...
                                    <div class="choose-image">
                                        ...
                                        <button class="classiera_verify_btn" data-toggle="modal" data-target="#verifyModal" type="button"> <i class="fas fa-check"></i> <?php esc_html_e( 'Verify your account', 'classiera' ); ?></button>
										<?php } ?>
										<!-- verify profile btn-->
                                    </div>									
                                </div>
							...
							<div class="form-inline row form-inline-margin">
								<div class="form-group col-sm-5">
                                    ...
                                    <div class="inner-addon">
                                        <input type="text" id="first-name" name="first_name" class="form-control form-control-sm" placeholder="<?php esc_html_e( 'Enter your first name', 'classiera' ); ?>" value="<?php echo esc_attr( $user_info->first_name ); ?>">
                                    </div>
                                </div><!--Firstname-->
								<div class="form-group col-sm-5">
									<label for="last-name"><?php esc_html_e( 'Last Name', 'classiera' ); ?></label>
									<div class="inner-addon">
										<input type="text" id="last-name" name="last_name" class="form-control form-control-sm" placeholder="<?php esc_html_e( 'Enter your last name', 'classiera' ); ?>" value="<?php echo esc_attr( $user_info->last_name ); ?>">
									</div>
								</div><!--Last name-->
								<div class="form-group col-sm-12">
                                    <label for="bio"><?php esc_html_e( 'Biography', 'classiera' ); ?></label>
                                    <div class="inner-addon">
                                        <textarea name="desc" id="bio" placeholder="<?php esc_html_e( 'Type a short info about yourself', 'classiera' ); ?>"><?php echo esc_html( $user_info->description ); ?></textarea>
                                    </div>
                                </div><!--biography-->
							</div>
							<!-- user basic information -->
							...
							<div class="form-inline row form-inline-margin">
								<div class="form-group col-sm-5">
                                    ...
                                    <div class="inner-addon">
                                        <input type="tel" id="phone" class="form-control form-control-sm" placeholder="<?php esc_html_e( 'Enter your phone number', 'classiera' ); ?>" name="phone" value="<?php echo esc_html( $user_info->phone ); ?>">
                                    </div>
                                </div><!--Phone Number-->
								<div class="form-group col-sm-5">
                                    <label for="mobile"><?php esc_html_e( 'Mobile Number', 'classiera' ); ?></label>
                                    <div class="inner-addon">
                                        <input type="tel" id="mobile" class="form-control form-control-sm" placeholder="<?php esc_html_e( 'Enter your mobile number', 'classiera' ); ?>" name="phone2" value="<?php echo esc_html( $user_info->phone2 ); ?>">
                                    </div>
                                </div><!--Mobile Number-->
								<div class="form-group col-sm-5">
								...
								<div class="form-group col-sm-5">
                                    ...
                                    <div class="inner-addon">
                                        <div class="input-group">
                                            ...
                                            <input type="url" id="digg" name="digg" class="form-control form-control-sm" placeholder="<?php esc_html_e( 'Enter your Digg URL', 'classiera' ); ?>" value="<?php echo esc_url( $user_info->digg ); ?>">
                                        </div>
                                    </div>
                                </div><!--digg-->
								<div class="form-group col-sm-5">
                                    ...
                                    <div class="inner-addon">
                                        <div class="input-group">
                                            ...
                                            <input type="url" id="behance" name="behance" class="form-control form-control-sm" placeholder="<?php esc_html_e( 'Enter your Behance URL', 'classiera' ); ?>" value="<?php echo esc_url( $user_info->behance ); ?>">
                                        </div>
                                    </div>
                                </div><!--behance-->
								<div class="form-group col-sm-5">
                                    ...
                                    <div class="inner-addon">
                                        <div class="input-group">
                                            ...
                                            <input type="url" id="dribbble" name="dribbble" class="form-control form-control-sm" placeholder="<?php esc_html_e( 'Enter your Dribble URL', 'classiera' ); ?>" value="<?php echo esc_url( $user_info->dribbble ); ?>">
                                        </div>
                                    </div>
                                </div><!--dribbble-->
								<div class="form-group col-sm-5">
                                    ...
                                    <div class="inner-addon">
                                        <div class="input-group">
                                            ...
                                            <input type="url" id="flickr" name="flickr" class="form-control form-control-sm" placeholder="<?php esc_html_e( 'Enter your Flickr URL', 'classiera' ); ?>" value="<?php echo esc_url( $user_info->flickr ); ?>">
                                        </div>
                                    </div>
                                </div><!--flickr-->
								<div class="form-group col-sm-5">
                                    ...
                                    <div class="inner-addon">
                                        <div class="input-group">
                                            ...
                                            <input type="url" id="github" name="github" class="form-control form-control-sm" placeholder="<?php esc_html_e( 'Enter your GitHub URL', 'classiera' ); ?>" value="<?php echo esc_url( $user_info->github ); ?>">
                                        </div>
                                    </div>
                                </div><!--github-->
								<div class="form-group col-sm-5">
                                    ...
                                    <div class="inner-addon">
                                        <div class="input-group">
                                            ...
                                            <input type="url" id="lastfm" name="lastfm" class="form-control form-control-sm" placeholder="<?php esc_html_e( 'Enter your Last.fm URL', 'classiera' ); ?>" value="<?php echo esc_url( $user_info->lastfm ); ?>">
                                        </div>
                                    </div>
                                </div><!--lastfm-->
								<div class="form-group col-sm-5">
                                    ...
                                    <div class="inner-addon">
                                        <div class="input-group">
                                            ...
                                            <input type="url" id="soundcloud" name="soundcloud" class="form-control form-control-sm" placeholder="<?php esc_html_e( 'Enter your SoundCloud URL', 'classiera' ); ?>" value="<?php echo esc_url( $user_info->soundcloud ); ?>">
                                        </div>
                                    </div>
                                </div><!--soundcloud-->
								<div class="form-group col-sm-5">
                                    ...
                                    <div class="inner-addon">
                                        <div class="input-group">
                                            ...
                                            <input type="url" id="vk" name="vk" class="form-control form-control-sm" placeholder="<?php esc_html_e( 'Enter your VK URL', 'classiera' ); ?>" value="<?php echo esc_url( $user_info->vk ); ?>">
                                        </div>
                                    </div>
                                </div><!--vk-->
							</div><!--form-inline-->
							...
							<div class="form-inline row">
                                <div class="form-group col-sm-5">
                                    ...
                                    <div class="inner-addon">
                                        <input type="password" id="current-pass" name="pwd" class="form-control form-control-sm" placeholder="<?php esc_html_e( 'Enter your current password', 'classiera' ); ?>" autocomplete="new-password">
                                    </div>
                                </div>
                            </div><!--currentpass-->
							<div class="form-inline row">
                                <div class="form-group col-sm-5">
                                    ...
                                    <div class="inner-addon">
                                        <input type="password" name="confirm" data-minlength="5" class="form-control form-control-sm" placeholder="<?php esc_html_e( 'Enter new password', 'classiera' ); ?>" id="new-pass" data-error="<?php esc_html_e( 'Password required', 'classiera' ); ?>">
							...
							<div class="form-inline row">
                                <div class="form-group col-sm-5">
                                    ...
                                    <div class="inner-addon">
                                        <input type="password" id="re-enter" name="confirm2" class="form-control form-control-sm sharp-edge" placeholder="<?php esc_html_e( 'Re-enter New Password', 'classiera' ); ?>" data-match="#new-pass" data-match-error="<?php esc_html_e( 'Whoops, these don&rsquo;t match', 'classiera' ); ?>">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<form method="post" class="form-inline row classiera_verify_form" <?php if($dbcode){ ?>style="display:block;" <?php } ?>>
					...
					<div class="form-group col-sm-9">
						<input type="text" class="form-control verification_code" placeholder="<?php esc_html_e('Enter your verification code', 'classiera') ?>" value="" required>
						<input type="hidden" value="<?php echo esc_attr( $user_ID ); ?>" name="" class="verify_user_id">
