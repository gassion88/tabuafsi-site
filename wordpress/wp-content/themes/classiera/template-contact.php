...
$classieraPrimaryColor = '';
$classieraSecondaryColor = '';
$classieraContactLatitude = '';
$classieraContactLongitude = '';
$ClassieraContactZoomLevel = '';
$classieraContactRadius = '';
$classieraMAPStyle = '';
$contactAddress = '';
$contactPhone = '';
$contactPhone2 = '';
$termsandcondition = '';
$classieraDisplayEmail = false;
		...
		<div class="row">
						...
						<div class="form-inline row">
							<div class="form-group col-sm-6">
                                ...
                                <div class="inner-addon left-addon">
                                    ...
                                    <input id="name" type="text" name="contactName" class="form-control form-control-md" placeholder="<?php esc_html_e( 'Enter your full name', 'classiera' ); ?>" data-error="<?php esc_html_e( 'Name Required', 'classiera' ); ?>" required>
							...
							<div class="form-group col-sm-6">
                                ...
                                <div class="inner-addon left-addon">
                                    <i class="left-addon form-icon far fa-eye"></i>
			...
			<div class="col-lg-4">
				...
				<?php if(!empty($contact_email)){ ?>
                    <li><i class="fa-li fas fa-envelope"></i>
