...
if ($homeLayout):
	foreach ($homeLayout as $key=>$value) { 
			switch($key) {
					...
					break;
					case 'slidermini': get_template_part( 'templates/slider/sliderv5' );
					break;
					...
					break;
					case 'searchmini': get_template_part( 'templates/searchbar/searchminimal' );
					break;
					...
					break;
					case 'premiumslider7': get_template_part( 'templates/premium/premiumv7' );
					break;
					case 'premiumslider8': get_template_part( 'templates/premium/premiumvmini' );
					break;
					...
					break;
					case 'categories8': get_template_part( 'templates/category/catstyle8' );
					break;
					case 'categories9': get_template_part( 'templates/category/catstyle9' );
					break;
					case 'categories10': get_template_part( 'templates/category/catstyle10' );
					break;
					...
					break;					
					case 'locationv6': get_template_part( 'templates/locations/locationsv6' );
					break;
					case 'locationv7': get_template_part( 'templates/locations/locationsmini' );
					break;
