 ...
 */
 function classiera_register_required_plugins(){
    ...
    $config = array(
        ...
        'message'           => __( '<p>Install <strong>Nextend or AccessPress</strong> social login plugin, both plugins are optional, If you are not able to install <strong>AccessPress</strong> plugin then you can try <strong>Nextend</strong> social login.</p>', 'classiera' ),
        'strings'           => array(
