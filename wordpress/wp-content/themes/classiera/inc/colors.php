...
function classiera_wpcss_head() {
	...
	if(!empty($classieraDescColor)){
		echo ".members-v1 .members-text p, .members-v4 .member-content p, .members-v3 .members-text p{ color: ";
